"""Ingestion logic for Jaeger trace data.
Parses Jaeger JSON exports and converts span references into weighted directed
edges for the service dependency graph.
"""
