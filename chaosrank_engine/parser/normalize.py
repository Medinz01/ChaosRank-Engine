"""String normalization and alias resolution for ChaosRank.
Strips transient identifiers (versions, pod hashes) from service names to
ensure stable component IDs across deployment cycles.
"""
