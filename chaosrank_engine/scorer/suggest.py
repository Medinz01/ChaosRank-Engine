"""Fault suggestion logic for ChaosRank.
Analyzes effective incidents to recommend the most relevant chaos experiment type.
"""
import logging
import math
...
def _confidence(effective_n: int, purity: float) -> str:
    """Calculate recommendation confidence based on sample size and type purity."""
...
def suggest_fault(
    ...
    """Recommend a fault type and confidence level for a given service."""
